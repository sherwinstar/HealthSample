//
//  HealthCombinedViewController.swift
//  HealthSample
//
...
class HealthCombinedViewController: ChartBaseViewController {
...
//        chartView.legend = l
    ...
    func generateLineData() -> LineChartData {
        ...
        let set = LineChartDataSet(entries: entries, label: "Sports")
    ...
    func generateBarData() -> BarChartData {
        ...
        let set1 = BarChartDataSet(entries: entries1, label: "Health")
        ...
        set2.stackLabels = ["Weight", "Calorie"]
...
extension HealthCombinedViewController: AxisValueFormatter {
